...
const Input = ({label,onChange,value,type,onBlur,error}) => {
  return (
    <div className="relative w-full">
      <input placeholder="" name={label.toLowerCase()} id={label.toLowerCase()} type={type} onChange={onChange} onBlur={onBlur} value={value} className={`border-[2px] pt-1.5 peer pl-4 focus:outline-none h-14 font-medium rounded-3xl w-full ${error ? "!border-red-500" : ""}`}/>
